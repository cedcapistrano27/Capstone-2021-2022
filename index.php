...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index_agency.html">BV Construction</a>
          </div>
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a href="#totop" >Home</a>
              ...
              <li class="section-scroll"><a href="#works" >Works</a>
      ...
      <section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" id="home" data-background="images/cover.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            <div class="font-alt mb-30 titan-title-size-1">Our Success</div>
            <div class="font-alt mb-40 titan-title-size-3">Make Homes<span class="rotate"> aesthetic | comfy | modern</span>
      ...
      <div class="main">
            ...
            <div class="row multi-columns-row">
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="features-item">
                  ...
                  <h3 class="features-title font-alt">Ideas and concepts</h3>Sharing ideas and recommendations with functional installation gives you the best output we can.
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="features-item">
                  <div class="features-icon"><span class="icon-tools"></span></div>
                  <h3 class="features-title font-alt">Designs &amp; interfaces</h3>Attention to design and hearing what you need We make your home cozy with a modern look.
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="features-item">
                  <div class="features-icon"><span class="icon-tools-2"></span></div>
                  <h3 class="features-title font-alt">development</h3>Careful attention to detail and clean, well structured to ensures a smooth experience for all your visitors.
                </div>
              </div>
        ...
        <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="images/Cover.PNG" >
                  ...
                  <ul class="slides">
                    ...
                    if ($result->num_rows > 0) {
                       while ($row = mysqli_fetch_assoc($result)) {
                         ...
                         echo "<li><img class='center-block' src='admin/$picpath' alt='Slider Image'/></li>";
                       }


                    }else{
                        echo "No slide images";
                       }
                     ...
                     ?>
                    <!---<li><img class="center-block" src="images\1.jpg" alt="Slider Image"/></li>
                    <li><img class="center-block" src="images\2.jpg" alt="Slider Image"/></li>
                    <li><img class="center-block" src="images\3.jpg" alt="Slider Image"/></li>
                    <li><img class="center-block" src="images\4.jpg" alt="Slider Image"/></li>--->
