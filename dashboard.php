...
<html lang="en-US" dir="ltr">
  ...
  <style>
    ...
    .AL {
      ...
      margin: 20% 0%;
      border-radius: 20px;
      box-shadow: 10px 10px 20px rgb(133, 131, 131);
    ...
    <main>
      ...
      <div class="container"  style="margin-top: -20px;">
        <div class="row" >
          ...
          <div id="APM">
          <div class="col-sm-10" style="background-color:rgb(232, 232, 232);height: 1300px;padding: 0px 35px 0px 35px;">
            ...
            <div class="AL col-sm-12" id="AL">
              <a class="close" aria-label="Close" onclick="listclose()">
